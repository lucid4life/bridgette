...
export const PRON_TERMS: readonly PronTerm[] = [
  ...
  { term: "kefta", respell: "KEF-tah", slug: "kefta", priority: "nice", dishes: ["lamb-sausage"] },  { term: "Maldon", respell: "MAWL-dun", slug: "maldon", priority: "nice", dishes: ["burrata-cheese", "italian-sausage"] },
  ...
  { term: "sofrito", respell: "soh-FREE-toh", slug: "sofrito", priority: "nice", dishes: ["italian-sausage", "bigoli"] },  { term: "tuile", respell: "TWEEL", slug: "tuile", priority: "nice", dishes: ["apple-tatin"] },
