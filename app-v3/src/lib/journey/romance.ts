...
export const ROMANCE: Record<string, string> = {
  ...
  'mushrooms-on-toast': 'Here we have the mushrooms on toast — a silky mushroom parfait piped over toasted pain de mie, finished with a thyme-honey drizzle and a generous grating of fresh black truffle.',
  // Vegetables
