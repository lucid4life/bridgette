// app-v3/src/lib/data/data.js — GENERATED from src/data.js by tools/build_app_data.mjs.
...
export const data = {
  ...
  "wines": [
    {
      "id": "blue-mountain-brut",
      "producerStory": "The Mavety family has farmed this bench above Vaseux Lake in Okanagan Falls since 1971 and opened the winery in 1991 — it's still family-run today, with the second generation handling winemaking and sales. Everything is estate-grown: they make wine only from their own vineyards, never purchased fruit.",
      "whyWePourIt": "Our all-purpose opener and the only Canadian pour by the glass: dry, crisp bubbles at glass price that reset the palate against oysters, fries, and anything salty or fried.",
      "compare": [
        "vs Fattoria Moretto Semprebon: both fizz, opposite jobs — Blue Mountain is dry, white, and palate-cleansing; the Moretto is a gently off-dry chilled RED with fruit and grip for sausage and pizza.",
        "vs Ameztoi Rubentis: Blue Mountain is a true sparkling wine with a fine, persistent mousse; the Ameztoi is a still rosé with just a light natural spritz and a saltier, leaner shape."
      ],
      "name": "Blue Mountain Brut",
      "group": "wine",
      "category": "Bubbly",
      "glass": true,
      "price": "18 | 29 | 90",
      "grape": "Chardonnay & Pinot Noir",
      "region": "Okanagan Falls, British Columbia",
      "country": "Canada",
      "vintage": "NV",
      "exclusive": false,
      "vegan": null,
      "veganNote": "Likely NOT vegan — the winery fines whites/sparkling with casein and bentonite (Barnivore); confirm before serving a vegan guest.",
      "climate": "cool",
      "family": "Bubbles & Rosé",
      "objections": [
        {
          "cue": "Is it sweet like Prosecco?",
          "reply": "No — it's a dry Brut, drier and more Champagne-shaped than Prosecco. Crisp green apple and citrus, no sugar."
        },
        {
          "cue": "We're not really Champagne people.",
          "reply": "Fair — think of it as a clean palate-reset for oysters or fries, not a celebration wine."
        },
        {
          "cue": "What's a good-value bubbles?",
          "reply": "This is the value pour by the glass; to step the table up, the Blanc de Noirs bottle is the move."
        }
      ],
      "pronunciation": {
        "say": "Blue Mountain Brut",
        "respell": "BLOO MOWN-tin BROOT"
      },
      "structure": {
        "acidity": "high",
        "body": "medium",
      ...
      "mnemonic": "Blue Mountain = cool BC mountain air = crisp, cool bubbles.",
      "aliases": [
        "brut",
        "bubbles",
        "sparkling",
      ...
      "upgrade": "Raventos i Blanc de Nit Rose or Griesel Blanc de Noirs",
      "tags": [
        "wine",
        "bubbly",
        "seafood",
    ...
    {
      "id": "fattoria-moretto-semprebon",
      "producerStory": "A small family farm in the hills of Castelvetro in Emilia-Romagna, founded in 1971 and now run by brothers Fausto and Fabio Altariva, the third generation. They specialize in Lambrusco Grasparossa and farm organically; 'Semprebon' is dialect for 'always good.'",
      "whyWePourIt": "Fills a slot nothing else on the list can: a chilled, gently off-dry sparkling red whose fruit and fizz handle salami, Calabrian chili, and honey at the same time — where dry whites and tannic reds both fail.",
      "compare": [
        "vs Blue Mountain Brut: both bubbly, but the Moretto is red, fruity, and off-dry with a little tannin grip; Blue Mountain is white, bone-dry, and purely refreshing.",
        "vs Sindicat la Figuera: same juicy-red-fruit-for-sausage lane, but the Moretto is cold and fizzy while the Figuera is a still, warm-spiced red."
      ],
      "storyMnemonic": "Semprebon = 'sempre buono' — ALWAYS GOOD. Picture a nonna in Castelvetro pouring purple fizz over a sausage pizza and shouting 'SEMPRE BON!' every single time. Cold purple bubbles, always good with cured pork — that's the whole wine.",
      "name": "Fattoria Moretto Semprebon",
      "group": "wine",
      "category": "Bubbly",
      "glass": true,
      "price": "18 | 29 | 90",
      ...
      "objections": [
        ...
        },
        {
          ...
          "reply": "It's a serious food wine — chilled, with black-cherry fruit and a little grip made for salami, sausage, and pizza."
        }
      ],
      "pronunciation": {
        "say": "Fattoria Moretto Semprebon",
        "respell": "fah-TOH-ree-ah moh-REH-toh sem-preh-BOHN"
      },
      "structure": {
        "acidity": "high",
        "body": "medium",
      ...
      "mnemonic": "Grasparossa = grape-rossa = red-grape fizz for red-meat snacks.",
      "aliases": [
        "lambrusco",
        "sparkling red",
        "fizzy red"
      ],
      "upgrade": "A fun bottle stays in this lane; for a richer red move to Sindicat la Figuera or Bodega Cerron Tinto.",
      "tags": [
        "wine",
        "bubbly",
        "red",
    ...
    {
      "id": "hiedler-loss",
      "producerStory": "The Hiedler family has made wine in Langenlois, in Austria's Kamptal, since 1856; today the next generation of Hiedlers runs the estate. The Löss bottling is named for the wind-blown loess soil its Grüner Veltliner vines grow on — fine glacial dust deposited over millennia.",
      "whyWePourIt": "The crisp, peppery white that handles green vegetables nothing else can — asparagus, cucumber, tahini, herbs — thanks to Grüner's white-pepper snap and high acid.",
      "compare": [
        "vs Darting Dürkheimer Fronhof: both high-acid Germanic whites, but the Hiedler is bone-dry and white-peppery for green plates; the Darting is off-dry and peachy for spicy ones.",
        "vs Dona Matilde Branco: both food whites, but the Hiedler is the zippier, higher-acid, peppery one; the Branco is rounder and more herbal-citrus for olives and brine."
      ],
      "storyMnemonic": "HEED-ler LURSS — hear 'Heed the loess!' Picture a stern Austrian farmer yelling at you as a storm of pale glacial dust blows over his vines; when the dust settles on your tongue, it tastes of white pepper and lime. Heed the loess, and you'll never blank on the soil or the snap.",
      "name": "Hiedler Löss",
      "group": "wine",
      "category": "White",
      "glass": true,
      ...
      "objections": [
        {
          "cue": "Can I drink a white with my steak?",
          "reply": "You can, but a crisp Grüner feels light next to beef — I'd save it for greens or seafood and pour a Claret with the steak."
        },
        {
          "cue": "Is it sweet?",
          "reply": "No, it's dry — high-acid and white-peppery, so it tastes fresh and snappy rather than sweet."
        },
        {
          "cue": "I usually order Sauvignon Blanc.",
          "reply": "Then you'll like this — same crisp, high-acid lane, a touch less grassy and more peppery."
        }
      ],
      "pronunciation": {
        "say": "Hiedler Löss",
        "respell": "HEED-ler LURSS"
      },
      "structure": {
        "acidity": "high",
        "body": "medium",
    ...
    {
      "id": "vini-be-good-hip-hop-chenin",
      "producerStory": "Vini be Good isn't a single winery — it's a Loire Valley collective of roughly 35 quality-minded growers, the team behind the Les Athlètes du Vin label, focused on honest, fairly priced Loire wines with environmentally careful farming. The Chenin in this 'Wine Is Music' line is reportedly vinified in stainless steel to keep it fresh and pure.",
      "whyWePourIt": "Our bridge white: fresh enough to sit with the crisp wines, textured enough to flirt with the round ones — the one glass that covers a mixed seafood table without a debate.",
      "compare": [
        "vs Hiedler Löss: both fresh Loire-vs-Austria whites, but the Chenin has more mid-palate texture and less pepper — Grüner zings, Chenin glides.",
        "vs Bodega Cerrón Remordimiento Blanco: the Chenin is the lighter, brighter half of the middle lane; the Cerrón Blanco is riper and rounder for buttery plates."
      ],
      "name": "Vini be Good Hip Hop Chenin",
      "group": "wine",
      "category": "White",
      "glass": true,
      "price": "16 | 26 | 80",
      ...
      "objections": [
        {
          "cue": "Is Chenin sweet?",
          "reply": "This one's dry-leaning, though Loire Chenin can range to off-dry — I'll confirm before promising bone-dry."
        },
        {
      ...
      "pronunciation": {
        "say": "Vini be Good Hip Hop Chenin",
        "respell": "VEE-nee beh good hip hop SHEN-in"
      },
      "structure": {
        "acidity": "high",
        "body": "medium",
      ...
      "upgrade": "Domaine Breton Pierres Rousses for the bottle Chenin lane.",
      "tags": [
        "wine",
        "white",
        "chenin",
    ...
    {
      "id": "wagner-stempel-weissburgunder",
      "producerStory": "Daniel Wagner is the ninth generation of his family at this estate in Siefersheim, a cool, hilly corner of western Rheinhessen with volcanic porphyry soils. He farms certified organic with extensive hand work, and the estate has been a member of Germany's elite VDP growers' association since 2004.",
      "whyWePourIt": "The 'nothing sharp, nothing oaky' comfort white — our answer for Pinot Grigio drinkers and anyone who finds white wine too aggressive, soft pear with real polish behind it.",
      "compare": [
        "vs Hiedler Löss: the two faces of our white list — Wagner-Stempel is soft, pear-like, and calm; the Hiedler is zippy, peppery, and bright. Soft hands vs snap.",
        "vs Bodega Cerrón Remordimiento Blanco: both rounder whites, but the Wagner-Stempel is quieter and gentler; the Cerrón is riper and fuller, built for buttery and creamy plates."
      ],
      "storyMnemonic": "'Stempel' is German for STAMP. Picture Wagner the village postmaster gently pressing a rubber stamp onto a soft white envelope — VICE-boor-goon-der — and a ripe pear slides out, certified 'NO SHARP EDGES.' The stamped-soft white.",
      "name": "Wagner-Stempel Weissburgunder",
      "group": "wine",
      "category": "White",
      "glass": true,
      "price": "17 | 27 | 85",
      ...
      "objections": [
        {
          "cue": "I find white wine too sharp.",
          "reply": "Then this is your pour — soft pear and apple, gentle acidity, nothing aggressive."
        },
        {
          "cue": "Do you have a Pinot Grigio?",
          "reply": "Not by the glass, but this Pinot Blanc is the same easy, pear-like lane — a bit softer and calmer."
        }
      ],
      "pronunciation": {
        "say": "Wagner-Stempel Weissburgunder",
        "respell": "VAHG-ner SHTEM-pel VICE-boor-goon-der"
      },
      "structure": {
        "acidity": "medium",
        "body": "medium",
      ...
      "avoid": "Can feel too quiet beside oysters or high-chili plates.",
      "say": "If you want an easy white that is not too sharp, this Pinot Blanc is soft, pear-like, and very comfortable with chicken, cheese, and creamy dishes.",
      "mnemonic": "Weissburgunder = white Burgundian = the soft white cousin of Pinot Grigio.",
      "aliases": [
        "weissburgunder",
        "pinot blanc",
        "pinot grigio",
      ...
      "upgrade": "Eleonore Moreau Petit Chablis or Mount Eden Wolff Vineyard for a more premium white.",
      "tags": [
        "wine",
        "white",
        "pinot blanc",
    ...
    {
      "id": "darting-durkheimer-fronhof",
      "producerStory": "A family winery in Bad Dürkheim in the Pfalz with roots back to 1780, run by Helmut and Ella Darting, farming around 18 hectares of vineyards in and around the town. The Fronhof is one of their own Dürkheim single-vineyard sites, and Riesling — roughly half of what they grow — is the house specialty.",
      "whyWePourIt": "The spice problem-solver: the only off-dry white by the glass, so it's the safe call whenever Calabrian chili, jalapeño, pickle, or honey-heat shows up on the table.",
      "compare": [
        "vs Hiedler Löss: both high-acid whites, but the Darting carries a touch of sweetness that tames chili; the Hiedler is bone-dry and peppery — heat wants the Riesling, greens want the Grüner."
      ],
      "storyMnemonic": "DARTING — picture a dart flying across the dining room and popping a flaming jalapeño like a balloon; it rains peach and lime juice. The dart that deactivates heat: that's this Riesling's whole job.",
      "name": "Darting Dürkheimer Fronhof",
      "group": "wine",
      "category": "White",
      "glass": true,
      "price": "14 | 23 | 70",
      ...
      "objections": [
        {
          "cue": "I don't like sweet wine.",
          "reply": "This sits just off-dry — the touch of fruit reads as freshness and is what tames chili; I can confirm the exact level by taste."
        },
        {
          "cue": "What works with the spicy dishes?",
          "reply": "This Riesling is the safest call — a little sweetness calms the Calabrian-chili heat instead of fighting it."
        }
      ],
      "pronunciation": {
        "say": "Darting Dürkheimer Fronhof",
        "respell": "DAR-ting DEWRK-hy-mer FROHN-hohf"
      },
      "structure": {
        "acidity": "high",
        "body": "medium",
      ...
      "structureNote": "German Riesling sweetness varies dry to off-dry — taste and confirm; don't oversell sweetness.",
      ...
      "avoid": "Do not promise it is bone dry until tasted.",
      "say": "Riesling is one of the safest pairing wines here, especially with chili, pickle, jalapeno, honey spice, and salty dishes.",
      "mnemonic": "Dürkheimer = D for Deutschland Riesling = the spice deactivator.",
      "aliases": [
        "riesling",
        "durkheimer",
        "moscato",
      ...
      "upgrade": "Donnhoff Feinherb for a bottle with more Riesling character.",
      "tags": [
        "wine",
        "white",
        "riesling",
    ...
    {
      "id": "dona-matilde-branco",
      "producerStory": "A historic Douro property in the Barros family since 1927 — wine entrepreneur Manoel Moreira de Barros renamed the quinta after his wife, Matilde. His grandson Manuel Ângelo Barros runs it today, and from the mid-1990s the family replanted vineyards with traditional Douro white grapes like Arinto, Viosinho, and Gouveio for table wines.",
      "whyWePourIt": "The briny-Mediterranean food white: citrus and herbs that lock onto olives, preserved lemon, and capers — flavours that make most whites taste thin.",
      "compare": [
        "vs Hiedler Löss: both food whites, but the Branco is a touch rounder and more herbal; the Hiedler is sharper, higher-acid, and peppery — brine vs greens.",
        "vs Wagner-Stempel Weissburgunder: both medium-acid and easy, but the Branco is citrus-herbal and savoury; the Wagner-Stempel is soft, pear-fruited comfort."
      ],
      "name": "Dona Matilde Branco",
      "group": "wine",
      "category": "White",
      "glass": true,
      "price": "14 | 23 | 70",
      "grape": "Arinto, Rabigato, Viosinho, Gouveio",
      ...
      "objections": [
        {
          "cue": "What even is this?",
          "reply": "A dry Portuguese white blend — citrusy and a bit herbal, great with olives, lemon, seafood, and pasta."
        },
        {
          "cue": "I want a crisp Sauvignon Blanc.",
          "reply": "If you want maximum zip the Grüner is crisper; this is a touch rounder but still fresh and food-friendly."
        }
      ],
      "pronunciation": {
        "say": "Dona Matilde Branco",
        "respell": "DOH-nah ma-TEEL-deh BRAHN-koo"
      },
      "structure": {
        "acidity": "medium",
        "body": "medium",
      ...
      "tenSecond": "A useful Portuguese food white — citrusy and herbal, great with olives, lemon, seafood, and pasta.",
      "profile": "A flexible Portuguese white that works with olives, preserved lemon, caper, seafood, and brown butter.",
      "pair": [
        "Roasted Olives",
        "Hummus Chips",
        "Grilled Octopus Salad",
      ...
      "avoid": "Less obvious for guests asking for very crisp Sauvignon Blanc style.",
      "say": "This is a really useful food white: citrusy, a bit herbal, and good with olives, preserved lemon, seafood, and pasta.",
      "mnemonic": "Branco = blanco = the Portuguese white blend.",
      "aliases": [
        "branco",
        "portuguese white",
        "arinto",
      ...
      "upgrade": "Clos Bellane Valreas or Domaine de la Rochette Macon-Bussieres for more body.",
      "tags": [
        "wine",
        "white",
        "seafood",
    ...
    {
      "id": "bodega-cerron-remordimiento-blanco",
      "producerStory": "A small family winery in Fuente-Álamo, on the high southern edge of the Jumilla appellation, where the same family has farmed since 1895 — today three siblings of the fourth generation run it. The winery says it earned one of Spain's earliest organic certifications back in 1995, and ferments with wild yeasts in amphorae and old wood.",
      "whyWePourIt": "Our Chardonnay answer: the fullest white by the glass — ripe lemon and pear with real weight for trout, crab, and buttery pasta — without tipping into a butter-and-vanilla bomb.",
      "compare": [
        "vs Wagner-Stempel Weissburgunder: both round whites, but the Cerrón is riper and fuller — the rich-plate pick; the Wagner-Stempel is the softer, quieter sipper.",
        "vs Bodega Cerrón Remordimiento Tinto: same winery, same 'Remordimiento' name — Blanco is the round Chardonnay, Tinto is the dark smoky Monastrell red. Don't ring in the wrong colour."
      ],
      "storyMnemonic": "'Remordimiento' is Spanish for REMORSE. Picture a guest in high, dusty Jumilla wracked with guilt — 'Chardonnay can't grow HERE!' — taking one sip of round, ripe lemon-pear white as the remorse melts off their face. No remorse ordering the fuller white.",
      "name": "Bodega Cerrón Remordimiento Blanco",
      "group": "wine",
      "category": "White",
      "glass": true,
      "price": "16 | 26 | 80",
      ...
      "objections": [
        {
          "cue": "I love a big buttery Chardonnay.",
          "reply": "This is our rounder Chardonnay lane — ripe lemon and pear with weight — though it's not a heavy butter-and-vanilla bomb."
        },
        {
      ...
      "pronunciation": {
        "say": "Bodega Cerrón Remordimiento Blanco",
        "respell": "boh-DEH-gah seh-RROHN reh-mor-dee-MYEN-toh BLAHN-koh"
      },
      "structure": {
        "acidity": "medium",
        "body": "medium",
      ...
      "upgrade": "Eleonore Moreau Petit Chablis, Mount Eden Wolff Vineyard, or Meursault for a premium Chardonnay lane.",
      "tags": [
        "wine",
        "white",
        "chardonnay",
    ...
    {
      "id": "ameztoi-rubentis",
      "producerStory": "The Ameztoi family has made Txakoli in Getaria, on Spain's Basque coast, for generations — Ignacio Ameztoi is at least the fifth — with estate vineyards looking straight out over the Bay of Biscay. Rubentis is their field blend of the local Hondarrabi Zuri and Hondarrabi Beltza grapes, drawing on very old Beltza vines the family preserved when neighbours pulled theirs out (the importer cites plantings back to 1840).",
      "whyWePourIt": "The raw-bar rosé: salty, bone-dry, and lightly spritzy — a coastal counterpoint to the Leitz that makes crudo, oysters, and cucumber taste more like themselves.",
      "compare": [
        "vs Leitz Eins Zwei Dry Rosé: the Ameztoi is salty, lean, and spritzy — a wine with sea air in it; the Leitz is still, clean, and red-berried — the crowd-pleaser. Coastal jolt vs easy charm."
      ],
      "storyMnemonic": "roo-BEN-tees — picture RUBEN THE BASQUE FISHERMAN cracking oysters on his boat in Getaria while sea spray fizzes into his glass of pink wine, turning it salty and spritzy. Ruben's tea-time at sea = Rubentis: the rosé with sea spray built in.",
      "name": "Ameztoi Rubentis",
      "group": "wine",
      "category": "Rosé",
      "glass": true,
      "price": "17 | 27 | 85",
      "grape": "Hondarrabi Zuri & Beltza",
      ...
      "objections": [
        {
          "cue": "Rosé is too sweet for me.",
          "reply": "Not this one — it's bone-dry, salty, and a little spritzy, more coastal than candy."
        },
        {
          "cue": "What do I pair a rosé with?",
          "reply": "Crudo, oysters, cucumber, salami — anything salty and fresh; the saline snap loves seafood."
        }
      ],
      "pronunciation": {
        "say": "Ameztoi Rubentis",
        "respell": "ah-MES-toy roo-BEN-tees"
      },
      "structure": {
        "acidity": "high",
        "body": "low",
      ...
      "say": "This rose is bright, dry, a little coastal, and excellent with seafood or anything salty and fresh.",
      "mnemonic": "Txakoli = chah-koh-LEE = cheeky coastal spritz.",
      "aliases": [
        "rose",
        "rosado",
        "txakoli",
      ...
      "upgrade": "Raventos i Blanc de Nit Rose for a bottle in a sparkling rose lane.",
      "tags": [
        "wine",
        "rose",
        "seafood",
    ...
    {
      "id": "leitz-eins-zwei-dry-rose",
      "producerStory": "Johannes Leitz took over his family's small Rüdesheim estate in 1985 and built it into one of the Rheingau's best-known names — the family's winemaking roots go back to 1744. Eins Zwei Dry is his everyday line; the rosé is Pinot Noir sourced mainly from central Rheingau villages.",
      "whyWePourIt": "The universal crowd-pleaser rosé: clean, dry, and friendly with salad, pizza, and chicken — the pour that never divides a table.",
      "compare": [
        "vs Ameztoi Rubentis: the Leitz is the calm one — still, clean red berry; the Ameztoi is the live wire — salty, spritzy, coastal. Easy-dry vs electric-dry."
      ],
      "name": "Leitz Eins Zwei Dry Rosé",
      "group": "wine",
      "category": "Rosé",
      "glass": true,
      "price": "16 | 26 | 80",
      ...
      "objections": [
        {
          "cue": "Is rosé sweet?",
          "reply": "This is a clean dry rosé — easy red-berry fruit, refreshing, no sugar."
        },
        {
      ...
      "pronunciation": {
        "say": "Leitz Eins Zwei Dry Rosé",
        "respell": "LITES ines tsvy dry roh-ZAY"
      },
      "structure": {
        "acidity": "high",
        "body": "low",
      ...
      "upgrade": "Light red bottle lane: Domaine de Colette or Alta Mora Etna Rosso.",
      "tags": [
        "wine",
        "rose",
        "pizza",
    ...
    {
      "id": "deinhard-deidesheim",
      "producerStory": "Made at von Winning in Deidesheim, Pfalz — an estate founded in 1849 as Weingut Dr. Deinhard and dramatically revived under winemaker Stephan Attmann after 2007. The Deinhard label is the estate's fresher, earlier-drinking line, keeping the historic founding name alive.",
      "whyWePourIt": "Our light-red slot: a soft, cherry-and-earth Pinot that pairs red-wine drinkers with delicate plates — mushrooms, carpaccio, duck, even trout — without bullying the food.",
      "compare": [
        "vs Ca' del Baio Langhe: both mid-weight reds for earthy food, but the Pinot is soft and low-tannin; the Nebbiolo has a firm, tea-like grip. Silk vs grip.",
        "vs Sindicat la Figuera: the Deinhard is lighter, earthier, and quieter; the Figuera is juicier and warm-spiced — the step up in generosity."
      ],
      "name": "Deinhard Deidesheim",
      "group": "wine",
      "category": "Red",
      "glass": true,
      "price": "17 | 27 | 85",
      ...
      "exclusive": false,
      "vegan": null,
      "veganNote": "Likely vegan — importers report no fining or filtering at the estate, but it is not certified; confirm if a guest needs certainty.",
      "climate": "warm",
      "family": "Light Reds",
      "objections": [
        {
          "cue": "I want a red but nothing heavy.",
          "reply": "Perfect — this German Pinot is light and soft, cherry and earth, great with mushrooms, duck, or even trout."
        },
        {
          "cue": "We loved a big Napa Cab.",
          "reply": "This is the opposite end — light and delicate. For Cab weight by the glass I'd point you to the Claret or Cerrón Tinto."
        }
      ],
      "pronunciation": {
        "say": "Deinhard Deidesheim",
        "respell": "DINE-hart DY-des-hime"
      },
      "structure": {
        "acidity": "medium",
        "body": "medium",
      ...
      "avoid": "May feel too light for ribeye guests expecting Cabernet weight.",
      "say": "This Pinot is lighter and softer, so it works with mushrooms, carpaccio, duck, and even trout without overpowering the food.",
      "mnemonic": "Deidesheim = the dainty German Pinot = the light red.",
      "aliases": [
        "pinot noir",
        "spatburgunder",
        "light red",
      ...
      "upgrade": "Domaine de Colette, Alta Mora Etna Rosso, Pierre Thibert Chorey-les-Beaune, or Kistler.",
      "tags": [
        "wine",
        "red",
        "pinot noir",
    ...
    {
      "id": "ca-del-baio-langhe",
      "producerStory": "A fourth-generation Grasso family estate in Treiso, in the heart of the Barbaresco zone, farming around 28 hectares of entirely estate-owned vineyards — the family has been there since the late 1800s. Giulio Grasso runs it with his wife and their three daughters, who are steadily taking over.",
      "whyWePourIt": "Structure without weight: the tannic, high-acid red for strip steak, lamb, and mushrooms when the table wants grip but not a heavy wine.",
      "compare": [
        "vs St. John Claret: both steak reds, but the Nebbiolo's power is tannin and acid in a medium body with rose-and-cherry perfume; the Claret is darker-fruited and rounder. Grip vs cushion.",
        "vs Bindi Sergardi La Boncia: both high-acid Italians — the Nebbiolo has firmer, tea-like tannin and rose aromatics; the Sangiovese is sour-cherry, lighter-gripped, and tomato-friendly."
      ],
      "storyMnemonic": "KAH del BY-oh — 'house of the BAY horse.' Picture a chestnut bay horse in a foggy Piedmont farmhouse, primly sipping black tea with a rose stem in its teeth. Horse + tea + rose = Nebbiolo: tea-grip tannin and rose perfume from the fog (nebbia).",
      "name": "Ca' del Baio Langhe",
      "group": "wine",
      "category": "Red",
      "glass": true,
      "price": "16 | 26 | 80",
      ...
      "objections": [
        {
          "cue": "Is this a big heavy red?",
          "reply": "It's medium-bodied but firm — red cherry, rose, and a dry tea-like grip; the structure is tannin, not weight."
        },
        {
          "cue": "Will it work with the 26oz ribeye?",
          "reply": "It can, but for that much beef I lead with the fuller Claret or Cerrón Tinto; the Nebbiolo shines on strip steak, lamb, and mushrooms."
        }
      ],
      "pronunciation": {
        "say": "Ca' del Baio Langhe",
        "respell": "kah del BY-oh LAHN-geh"
      },
      "structure": {
        "acidity": "high",
        "body": "medium",
      ...
      "mnemonic": "Nebbiolo = nebbia = fog = rose, tar, and tea-grip tannin.",
      "aliases": [
        "nebbiolo",
        "langhe",
        "barolo style"
      ],
      "upgrade": "Brandini Langhe Filari Corti or Fletcher Barbaresco Recta Pete.",
      "tags": [
        "wine",
        "red",
        "nebbiolo",
    ...
    {
      "id": "sindicat-la-figuera",
      "producerStory": "A tiny village co-operative in La Figuera, one of the highest, coolest corners of Montsant, originally founded in 1932 and revived in recent years by a handful of local growers — retailers credit encouragement from René Barbier of Priorat fame. They farm old Garnatxa vines (reportedly 30 to 100 years old) and keep the winemaking simple: native yeasts and gentle handling, no flash.",
      "whyWePourIt": "The juicy middle red — our answer to the Zinfandel ask: generous cherry fruit and warm spice for sausage, salami, lamb, and duck, easier than the Nebbiolo, lighter than the Tinto.",
      "compare": [
        "vs Bodega Cerrón Remordimiento Tinto: both warm Spanish reds, but the Figuera is juicy, mid-weight, and fresh; the Tinto is darker, fuller, and smokier — fruit vs muscle.",
        "vs Deinhard Deidesheim: both easy-drinking reds, but the Figuera brings ripe fruit and warm spice; the Pinot is lighter, earthier, and more delicate."
      ],
      "storyMnemonic": "SINDICAT = the growers' UNION; 'figuera' is Catalan for FIG TREE. Picture the village farmers' union of 1932 holding its meeting under one big fig tree on a Catalan mountainside, hands shooting up to vote: 'JUICY!' The fig-tree union of old Garnatxa vines.",
      "name": "Sindicat la Figuera",
      "group": "wine",
      "category": "Red",
      "glass": true,
      "price": "16 | 26 | 80",
      ...
      "objections": [
        {
          "cue": "Do you have a Zinfandel?",
          "reply": "Not exactly, but this Grenache gives that juicy, spicy red-fruit lane — a bit less jammy and high-alcohol."
        },
        {
          "cue": "Something easy but with flavour?",
          "reply": "This is juicy cherry and warm spice — easier than the Nebbiolo, great with salami, sausage, lamb, and duck."
        }
      ],
      "pronunciation": {
        "say": "Sindicat la Figuera",
        "respell": "sin-dee-KAHT lah fee-GEH-rah"
      },
      "structure": {
        "acidity": "medium",
        "body": "medium",
      ...
      "tenSecond": "Juicy cherry and warm spice — easier than Nebbiolo, great with salami, sausage, lamb, and duck.",
      "profile": "A generous red that is easier than Nebbiolo and great with sausage, salami, lamb, duck, and warm spice.",
      "pair": [
        "Burrata Cheese",
        "Fennel Salami",
        "Italian Sausage",
      ...
      "avoid": "Not as structured as Claret for guests wanting Cabernet style.",
      "say": "This Grenache is juicy and warm-spiced. I like it with salami, sausage, lamb, and duck.",
      "mnemonic": "Garnacha from Montsant = juicy red-fruit warmth (the Zinfandel stand-in).",
      "aliases": [
        "grenache",
        "garnacha",
        "zinfandel",
      ...
      "upgrade": "Terroir Sense Fronteres Negre de Montsant or Domaine Gour de Chaule Gigondas.",
      "tags": [
        "wine",
        "red",
        "grenache",
    ...
    {
      "id": "bindi-sergardi-la-boncia",
      "producerStory": "The Bindi Sergardi family has made wine around Siena since 1349 — they count 23 generations — and today Alessandra Casini Bindi Sergardi leads the estates, carrying on a line of women who ran the business before her. La Boncia is the name of historic family land whose winegrowing past the estate dates back to the Etruscans.",
      "whyWePourIt": "The tomato-and-pizza red: Sangiovese's high acid is the only thing on the list that meets tomato sauce head-on and stays lively instead of tasting flat.",
      "compare": [
        "vs Ca' del Baio Langhe: both high-acid Italian reds, but the Sangiovese is sour-cherry-bright with moderate grip for tomato and pasta; the Nebbiolo is firmer-tannined and more perfumed for steak and lamb.",
        "vs Sindicat la Figuera: the Boncia is the fresher, tangier red that loves tomato; the Figuera is riper and warmer for sausage without the sauce."
      ],
      "storyMnemonic": "lah BOHN-chah sounds like 'the BOUNCY.' Picture a sour cherry bouncing off a Margherita pizza — boing, boing — never going flat, because the acidity keeps it lively. La Boncia = the bouncy tomato red.",
      ...
      "exclusive": false,
      "vegan": null,
      "veganNote": "Likely NOT vegan — the estate sometimes uses egg-white (albumen) fining (Barnivore); confirm before serving a vegan guest.",
      "climate": "warm",
      "family": "Structured Reds",
      "objections": [
        {
          "cue": "What's the best wine for pizza?",
          "reply": "This Sangiovese — its high acidity matches tomato sauce so the wine stays lively instead of tasting flat."
        },
        {
          "cue": "Is it heavy?",
          "reply": "No — medium-bodied and fresh, built around sour-cherry acidity rather than weight."
        }
      ],
      "pronunciation": {
        "say": "Bindi Sergardi La Boncia",
        "respell": "BEEN-dee ser-GAR-dee lah BOHN-chah"
      },
      "structure": {
        "acidity": "high",
        "body": "medium",
      ...
      "tenSecond": "The tomato-and-pizza red — sour cherry and herbs with acidity built for tomato sauce, salami, and pasta.",
      "profile": "This is the tomato and pizza red. The acidity keeps tomato sauce, salami, and pasta lively.",
      "pair": [
        "Margherita",
        "Bigoli",
        "Ricotta Dumplings",
      ...
      "avoid": "Not the deepest ribeye bottle substitute.",
      "say": "Sangiovese is the classic tomato-and-pizza red: cherry, herbs, and enough freshness for pasta or salami.",
      ...
      "upgrade": "Castello di Potentino Sacromonte or Aia Vecchia Sor Ugo for a richer Italian red lane.",
      "tags": [
        "wine",
        "red",
        "sangiovese",
    ...
    {
      "id": "bodega-cerron-remordimiento-tinto",
      "producerStory": "Same family winery as the Blanco: a fourth-generation, sibling-run estate in Fuente-Álamo on Jumilla's high southern edge, farming organically since well before it was fashionable (the winery cites one of Spain's earliest organic certifications, 1995). The Tinto draws on older dry-farmed Monastrell from high Mediterranean vineyards, fermented with wild yeasts in amphorae and old wood.",
      "whyWePourIt": "The biggest glass on the list — our Malbec/Shiraz answer: dark, full, and smoky for ribeye, lamb, and sausage when the table wants muscle.",
      "compare": [
        "vs St. John Claret: both steak reds, but the Tinto is darker, smokier, and more rustic-Mediterranean; the Claret is the tidier, more classic Bordeaux shape. Fire vs polish.",
        "vs Sindicat la Figuera: both warm Spanish reds, but the Tinto is the full-bodied, high-tannin heavyweight; the Figuera is the juicy, easier middleweight."
      ],
      "name": "Bodega Cerrón Remordimiento Tinto",
      "group": "wine",
      "category": "Red",
      "glass": true,
      "price": "15 | 24 | 75",
      "grape": "Monastrell & Garnacha",
      "region": "Jumilla, Spain",
      "country": "Spain",
      "vintage": "2024",
      "exclusive": false,
      ...
      "objections": [
        {
          "cue": "Do you have a Malbec or Shiraz?",
          "reply": "Not by name, but this Monastrell-Garnacha is the closest — dark, full, smoky, and spicy."
        },
        {
          "cue": "I want your biggest red.",
          "reply": "This is it by the glass — plum, spice, and smoky earth with real body, made for lamb, sausage, and ribeye."
        }
      ],
      "pronunciation": {
        "say": "Bodega Cerrón Remordimiento Tinto",
        "respell": "boh-DEH-gah seh-RROHN reh-mor-dee-MYEN-toh TEEN-toh"
      },
      "structure": {
        "acidity": "medium",
        "body": "high",
      ...
      "avoid": "Can be too much for delicate seafood.",
      "say": "This is the darker Spanish red: plum, spice, and smoky earth. It is a good call for lamb, sausage, or ribeye.",
      ...
      "upgrade": "Gulfi Nerojbleo, Texier Brezeme, or Gigondas for bigger red drinkers.",
      "tags": [
        "wine",
        "red",
        "monastrell",
    ...
    {
      "id": "st-john-claret",
      "producerStory": "Not a château — this is the house claret of St. JOHN, the London restaurant that pioneered nose-to-tail cooking, blended for them in Bordeaux with the long-established Sichel family house; co-founder Trevor Gulliver has overseen the partnership for roughly two decades. It's a Cabernet-led blend built deliberately as an honest, drink-with-dinner Bordeaux rather than a collector's wine.",
      "whyWePourIt": "The safe steak red: recognizable Bordeaux structure that lets a Cabernet drinker order with confidence — dark fruit and grip for beef, no speech required.",
      "compare": [
        "vs Ca' del Baio Langhe: the Claret is darker-fruited and rounder — comfort and structure; the Nebbiolo is leaner with firmer, tea-like tannin and rose perfume.",
        "vs Bodega Cerrón Remordimiento Tinto: the Claret is the classic, savoury, buttoned-up steak red; the Tinto is bigger, smokier, and wilder — polish vs power."
      ],
      "name": "St. John Claret",
      "group": "wine",
      "category": "Red",
      ...
      "objections": [
        {
          "cue": "Is this one sweet?",
          "reply": "No — it's dry. The dark fruit can read as 'rich,' but there's no sugar; it's a savoury Bordeaux blend."
        },
        {
        ...
        },
        {
          ...
          "reply": "Meiomi is a deliberately sweetened, plush red — I can't fake that, but for a rich, smooth dry red the Claret or Cerrón Tinto land closest."
        }
      ],
      "pronunciation": {
        "say": "St. John Claret",
        "respell": "saynt jon KLA-ret"
      },
      "structure": {
        "acidity": "medium",
        "body": "medium",
      ...
      "avoid": "Tannin and structure can feel heavy with chili heat or crudo.",
      "say": "For steak, I would go Claret. It has dark fruit and enough structure for beef without feeling over the top.",
      "mnemonic": "Claret = the British word for red Bordeaux = the Cabernet/Merlot steak glass.",
      "aliases": [
        "claret",
        "cabernet",
        "cabernet sauvignon",
      ...
      "upgrade": "Chateau Larose Perganson, Whitehall Lane Merlot, Aia Vecchia Sor Ugo, or White Rock Cabernet Sauvignon.",
      "tags": [
        "wine",
        "red",
        "claret",
    ...
    {
      "id": "gallina-de-piel-neverwine",
      "producerStory": "Created by David Seijas, longtime head sommelier of Spain's legendary elBulli restaurant, under his Gallina de Piel wine project. It's an Albariño-style white de-alcoholized with a gentle vacuum process designed to keep the grape's aromas, and the name is a wink at Nirvana — 'Neverwine, smells like Albariño.'",
      "whyWePourIt": "Keeps non-drinkers in the pairing game: a 0.0% pour with a genuine wine shape — citrus and salinity for oysters, crudo, and lighter plates — instead of a sugary mocktail.",
      "compare": [
        "vs Hiedler Löss: both bright, food-first whites, but the Neverwine is 0.0% and reads a touch softer and slightly sweet; the Grüner has the full dry, peppery snap only alcohol-and-acid structure delivers."
      ],
      "name": "Gallina de Piel Neverwine",
      "group": "wine",
      "category": "No-Alcohol",
      "glass": true,
      "price": "10 | 12 | 50",
      ...
      "objections": [
        {
          "cue": "I'm not drinking tonight.",
          "reply": "Then this is for you — a zero-alcohol, wine-style pour: citrusy and saline, with a real pairing shape for seafood and lighter plates."
        },
        {
          "cue": "Will it taste like grape juice?",
          "reply": "No — it's drier and more savoury than juice, though de-alcoholized wines can read slightly sweet, so I'll let you taste first."
        }
      ],
      "pronunciation": {
        "say": "Gallina de Piel Neverwine",
        "respell": "gah-YEE-nah deh pyel NEV-er-wine"
      },
      "structure": {
        "acidity": "medium",
        "body": "low",
      ...
      "structureNote": "Non-alcoholic (0.0%); de-alcoholized wines often read slightly sweet and lighter in body — taste to confirm.",
      ...
      "mnemonic": "Neverwine = never alcohol = the 0.0% Albariño-style white.",
      "aliases": [
        "neverwine",
        "non-alcoholic",
        "zero proof",
      ...
      "upgrade": "Freixenet Sparkling Wine for bubbles or Noughty Rouge for a red-style option.",
      "tags": [
        "wine",
        "zero-proof",
        "seafood",
  ...
  "translator": [
    ...
    {
      "ask": "Oaky or buttery Chardonnay",
      "aliases": [
        "oaky chardonnay",
        "buttery chardonnay",
        "oaked chardonnay"
      ...
      "bottleOptions": [
        "Mount Eden Wolff Vineyard",
        "Domaine de la Rochette Macon-Bussieres",
        "Meursault"
      ],
      "familiar": "Rounder body, ripe citrus, pear, and texture. Works with garlic bread, shrimp and crab, cod, trout, and ricotta dumplings.",
      "different": "It is the richer white lane, but not a sweet butter bomb.",
      "phrase": "It is the richer white lane, but not a sweet butter bomb. If you want more premium Chardonnay depth, the bottles are stronger."
    },
    {
      "ask": "Sauvignon Blanc",
      "aliases": [
    ...
    },
    {
      ...
      "bestGlass": "Wagner-Stempel Weissburgunder",
      "bottleOptions": [
        "Hiedler Löss",
        "Maloof Where Ya Pjs At?"
      ],
      "familiar": "Light-to-medium feel, pear/apple fruit, and an easy-drinking shape. Good with chicken, cheese, potatoes, salads, and lighter snacks.",
      "different": "Pinot Blanc is softer and calmer than many sharp Pinot Grigios.",
      "phrase": "This is the comfortable easy white; if you want more zip, I would move you to the Grüner."
    },
    {
      "ask": "Riesling",
      "aliases": [
      ...
      "familiar": "Peach, lime, racy freshness, and a strong match for chili, pickle, honey spice, pork sausage, sprouts, and salty food.",
      "different": "Do not promise bone-dry or sweet until tasted.",
      "phrase": "Riesling is our best problem solver for spice; it has fruit and freshness, and I can confirm the sweetness level for you."
    },
    {
      "ask": "Moscato / sweet white",
      "aliases": [
        "moscato",
        "sweet white",
        "sweet wine"
      ...
      "phrase": "We do not have a sweet Moscato, but Riesling is the closest fruity white. For dessert, I can move you into sherry or port."
    },
    {
      "ask": "Rosé",
      "aliases": [
      ...
      "bestGlass": "Ameztoi Rubentis",
      "bottleOptions": [
        "Leitz Eins Zwei Dry Rosé"
      ],
      "familiar": "Dry, refreshing, pink, seafood-friendly, and easy with salads, crudo, burrata, pizza, squash, and chicken.",
      "different": "Ameztoi is more saline and energetic; Leitz is more classic and easy.",
      "phrase": "Ameztoi is the fun coastal rose; Leitz is the clean dry rose."
    },
    {
      "ask": "Prosecco / Champagne",
      "aliases": [
        "prosecco",
        "champagne",
        "cava",
      ...
      "familiar": "Bubbles, acid, freshness, and celebration feel. Great with oysters, fries, crudo, burrata, seafood, and salty snacks.",
      "different": "Blue Mountain is drier and more Champagne-shaped than Prosecco.",
      "phrase": "If you want bubbles, Blue Mountain is our crisp BC brut; if you want Champagne energy in a bottle, I can show you the Blanc de Noirs or Meunier."
    },
    {
      "ask": "Pinot Noir",
      "aliases": [
    ...
    },
    {
      ...
      "bestGlass": "St. John Claret",
      "bottleOptions": [
        "White Rock Cabernet Sauvignon",
        "Chateau Larose Perganson",
        "Aia Vecchia Sor Ugo"
      ],
      "familiar": "Dark fruit, structure, cedar/savoury Bordeaux shape, and enough grip for strip steak, ribeye, mushrooms, duck, and richer pasta.",
      "different": "Claret is Cabernet blended with Merlot, so it is a little softer than a big Napa Cab.",
    ...
    },
    {
      ...
      "familiar": "Plum, dark fruit, smoother texture than straight Cabernet, and a steak-friendly red that is not too aggressive.",
      "different": "Claret is more savoury/Bordeaux than plush California Merlot.",
      "phrase": "This is the Merlot-Cab blend by the glass; if you want a true Merlot bottle, Whitehall Lane is the move."
    },
    {
      "ask": "Malbec",
      "aliases": [
    ...
    },
    {
      ...
      "bestGlass": "Bodega Cerrón Remordimiento Tinto",
      "bottleOptions": [
        "Texier Brezeme Syrah",
        "Domaine Gour de Chaule Gigondas"
      ],
      "familiar": "Dark fruit, spice, savoury depth, and enough weight for lamb, sausage, ribeye, and smoky dishes.",
      "different": "Australian Shiraz is often plusher; Texier Syrah is more savoury and peppery.",
      "phrase": "By the glass I would use the Spanish red; for true Syrah, Texier is the bottle lane."
    },
    {
      "ask": "Chianti / Sangiovese",
      "aliases": [
        "chianti",
        "sangiovese",
        "tuscan"
      ],
      "bestGlass": "Bindi Sergardi La Boncia",
      "bottleOptions": [
        "Castello di Potentino Sacromonte",
        "Aia Vecchia Sor Ugo"
      ],
      "familiar": "Exact Sangiovese lane: sour cherry, herbs, tomato-friendly acidity, and a natural fit for Margherita, pasta, salami, and ricotta dumplings.",
      "different": "It is fresher and more food-driven than jammy.",
      "phrase": "This is the classic tomato-and-pizza red; if the table is going richer, I can move you into a bigger Italian bottle."
    },
    {
      "ask": "Zinfandel",
      "aliases": [
      ...
      "bestGlass": "Sindicat la Figuera",
      "bottleOptions": [
        "Bodega Cerrón Remordimiento Tinto"
      ],
      "familiar": "Generous fruit, spice, and comfort with salami, sausage, lamb, duck, and honey-chili pizza.",
      "different": "These are less jammy and less high-alcohol than many Zinfandels.",
      "phrase": "We do not have Zin, but this Grenache gives you the juicy, spicy red-fruit lane."
    },
    {
      "ask": "Rioja / Tempranillo",
      "aliases": [
        "rioja",
        "tempranillo"
      ],
      ...
      "familiar": "Red-fruit savoury profile, herbs, and a flexible pairing lane for tomato, salami, roasted meat, and mushrooms.",
      "different": "No Tempranillo by the glass; Sangiovese covers the freshness, Grenache the warmth.",
    ...
    },
    {
      ...
      "familiar": "Merlot/Cabernet structure, dark fruit, savoury edges, and steak-table confidence.",
      "different": "This is one of the cleanest matches.",
      "phrase": "Claret is the Bordeaux-style blend by the glass; if you want to build the table around a bottle, Larose Perganson is the direct upgrade."
    },
    {
      "ask": "House white / easy white",
      "aliases": [
        "house white",
        "easy white",
        "white wine"
      ...
      "familiar": "Approachable white wine without needing a long explanation.",
      "different": "Wagner is soft and pear-like; Hiedler Löss is crisp and bright.",
      "phrase": "Do you want softer and pear-like, or crisp and bright? Then I choose Wagner for soft or Grüner for crisp."
    },
    {
      "ask": "House red / easy red",
      "aliases": [
        "house red",
        "easy red",
        "red wine"
      ...
      "familiar": "Easy red choices by food lane: tomato, light red, or steak red.",
      "different": "Bindi Sergardi Sangiovese suits pizza/pasta; Deinhard Pinot Noir is the lighter red.",
  ...
  "lessons": [
    ...
    },
    {
      ...
      "quickCheck": {
        ...
        "choices": [
          "A high-tannin red to match the spice",
          "Off-dry Riesling — a little sweetness tames chili heat",
          "The biggest, highest-alcohol red on the list"
        ],
        "answer": 1
      }
    },
    {
      ...
      "quickCheck": {
        ...
        "choices": [
          "Grüner Veltliner (Hiedler Löss)",
          "Nebbiolo (Ca' del Baio)",
          "Monastrell (Bodega Cerrón Tinto)"
        ],
        "answer": 0
      }
    },
    {
      ...
      "quickCheck": {
        ...
        "choices": [
          "Like 'oss' in 'toss'",
          "Like 'urss' — round your lips and say 'ur'",
          "Like 'oh' in 'go'"
        ],
        "answer": 1
      }
    },
    {
      ...
      "quickCheck": {
        ...
        "choices": [
          "List every ingredient in the wine",
          "One structural reason — e.g. 'the acidity cuts the fat'",
          "The price of every bottle on the list"
        ],
        "answer": 1
      }
    },
    ...
    },
    {
      ...
      "quickCheck": {
        ...
        "choices": [
          ...
          "Always to your left, with seats numbered clockwise from there",
          "Wherever the oldest guest is sitting"
        ],
        "answer": 1
      }
    },
  ...
  "foods": [
    ...
    },
    {
      ...
      "price": "12",
      "menu": "Cheese Curd",
      "flavor": "rich, cheesy, garlic, salty",
    ...
    },
    {
      ...
      "price": "10",
      "menu": "Salt & Vinegar",
      "flavor": "salty, tangy, nutty",
      "wine": "Blue Mountain Brut",
      "cocktail": "White Peach Negroni",
      "zero": "Freixenet Sparkling Wine",
      "why": "Salt and toasty nuts want acid and bubbles; bitterness and freshness balance the fat and the salt-and-vinegar tang.",
      "flags": [
        "tree nuts"
      ],
      "ingredients": [
    ...
    {
      "id": "roasted-olives",
      "lever": "salt-softens-tannin",
      "name": "Roasted Olives",
      "group": "food",
      "category": "Snacks",
      "price": "10",
      "menu": "Herbs, Orange, Chili",
      "flavor": "salty, herbal, orange, chili",
      "wine": "Dona Matilde Branco",
      "cocktail": "White Peach Negroni",
      "zero": "Sunrise Spritz",
      "why": "Briny salt and bitterness want a herbal high-acid white or a bitter aperitivo; salt softens the wine and acid balances the brine.",
      "flags": [
        "confirm pits"
      ],
      "ingredients": [
    ...
    {
      "id": "bread-butter",
      "lever": "tannin-binds-protein",
      "name": "Bread & Butter",
      "group": "food",
      "category": "Snacks",
      "price": "10",
      "menu": "Smoked Tallow, Charred Onion",
      "flavor": "smoky, fatty, savory",
      "wine": "St. John Claret",
      "cocktail": "Rolling Canoe",
      "zero": "Noughty Rouge",
      "why": "Smoke and tallow fat can take dark red fruit or whiskey-port richness; intensity matches intensity and a little grip cuts the fat.",
      "flags": [
        "beef tallow",
        "gluten",
        "dairy"
    ...
    {
      "id": "oysters-1-2-dozen",
      "lever": "match-intensity",
      "name": "Oysters 1/2 dozen",
      "group": "food",
    ...
    },
    {
      ...
      "category": "Small Plates",
      "price": "20",
      "menu": "Smoked Tonnato, Puttanesca Vinaigrette, Fried Caper, Mint",
      "flavor": "raw tuna, salty caper, smoky, mint, vinaigrette",
      "wine": "Ameztoi Rubentis",
      "cocktail": "Cloud 9",
      "zero": "Gallina de Piel Neverwine",
      "why": "Salty caper and vinaigrette love a dry rose, bubbles, or saline zero-proof; acid matches the dressing and keeps raw fish clean.",
      "flags": [
        "raw seafood",
        "fish"
      ],
    ...
    {
      "id": "spiced-beet-salad",
      "lever": "salt-softens-tannin",
      "name": "Spiced Beet Salad",
      "group": "food",
      "category": "Vegetables",
      "price": "16",
      "menu": "Whipped Feta, Pickled Shallots, Herbs, Pistachio",
      "flavor": "earthy beet, salty feta, pickle, herbs, nuts",
      "wine": "Leitz Eins Zwei Dry Rosé",
      "cocktail": "Heartbreak Mountain",
      "zero": "Sunrise Spritz",
      "why": "Earthy-sweet beet and salty feta want a dry rose or floral citrus; salt softens the wine and acid balances the beet's sweetness.",
      "flags": [
        "dairy",
        "pistachio"
      ],
    ...
    },
    {
      ...
      "category": "Vegetables",
      "price": "15",
      "menu": "Charred Shallot Aioli, Avonlea Cheddar, Chive",
      "flavor": "crispy, cheesy, aioli, onion",
      "wine": "Wagner-Stempel Weissburgunder",
      "cocktail": "Cloud 9",
      "zero": "Peroni Pilsner 0.0",
      "why": "Creamy potato and aioli want a soft white, citrus cocktail, or crisp beer; acid and bubbles cut the fat without adding harshness.",
      "flags": [
        "dairy",
    ...
    {
      "id": "bibb-lettuce",
      "lever": "sweet-tames-heat",
      "name": "Bibb Lettuce",
      "group": "food",
      "category": "Vegetables",
      "price": "16",
      "menu": "Jalapeño Cream, Puffed Grains, Alpine Cheese",
      "flavor": "green, creamy, jalapeño, cheese",
      "wine": "Darting Dürkheimer Fronhof",
      "cocktail": "Lovers Mountain",
      "zero": "Lovers Mountain",
      "why": "Jalapeño cream needs freshness and a little aromatic lift; acid cuts the cream and a fresh white keeps the heat in check.",
      "flags": [
        "dairy",
        "jalapeño"
      ],
    ...
    },
    {
      ...
      "category": "Pizza",
      "price": "20",
      "menu": "Tomato, Mozzarella, Basil",
      "flavor": "tomato, cheese, basil",
      "wine": "Bindi Sergardi La Boncia",
      "cocktail": "Eat, Apres, Love",
      "zero": "Noughty Rouge",
      "why": "Tomato's acidity needs an equally high-acid red (Sangiovese) so the wine doesn't taste flat against the sauce.",
      "flags": [
        "dairy",
        "gluten"
      ],
    ...
    },
    {
      ...
      "category": "Pizza",
      "price": "24",
      "menu": "Bacon, Garlic Bechamel, Mushroom, Jalapeño",
      "flavor": "creamy, bacon, mushroom, jalapeño",
      "wine": "Fattoria Moretto Semprebon",
      "cocktail": "Paradise City",
      "zero": "Peroni Pilsner 0.0",
      "why": "Cream, bacon, mushroom, and jalapeño heat want fizz and fruit; bubbles cut the cream and fruit tames the chili.",
      "flags": [
        "pork",
        "dairy",
        "gluten",
    ...
    },
    {
      ...
      "category": "Pizza",
      "price": "23",
      "menu": "Provolone, Fontina, Fior di Latte, Oka, Parmesan",
      "flavor": "rich cheese, salt, creamy",
      "wine": "Wagner-Stempel Weissburgunder",
      "cocktail": "Spaghetti Western",
      "zero": "Freixenet Sparkling Wine",
      "why": "Rich salty cheese wants acid or bubbles to reset the palate; a soft white comforts while sparkling cuts the fat.",
      "flags": [
        "dairy",
        "gluten"
      ],
    ...
    {
      "id": "ricotta-dumplings",
      "lever": "acid-cuts-fat",
      "name": "Ricotta Dumplings",
      "group": "food",
      "category": "Pasta",
      "price": "22",
      "menu": "Vodka Tomato Sauce, Basil",
      "flavor": "ricotta, tomato cream, basil",
      "wine": "Bindi Sergardi La Boncia",
      "cocktail": "White Peach Negroni",
      "zero": "Noughty Rouge",
      "why": "Tomato-cream sauce needs acidity to stay lively; high-acid Sangiovese cuts the cream and matches the tomato.",
      "flags": [
        "dairy",
        "gluten"
      ],
    ...
    },
    {
      ...
      "category": "Pasta",
      "price": "25",
      "menu": "Linguini, Brown Butter, Chili",
      "flavor": "shellfish, brown butter, chili",
      "wine": "Bodega Cerrón Remordimiento Blanco",
      "cocktail": "Cloud 9",
      "zero": "Gallina de Piel Neverwine",
      "why": "Brown butter wants a rounder white for body while citrus keeps shellfish and chili awake; richness matches richness and acid lifts the chili.",
      "flags": [
        "shellfish",
        "gluten",
        "dairy",
    ...
    },
    {
      ...
      "category": "Pasta",
      "price": "23",
      "menu": "Pomodoro, Crushed Olive, Caper, Parsley",
      "flavor": "tomato, olive, caper, parsley",
      "wine": "Dona Matilde Branco",
      "cocktail": "White Peach Negroni",
      "zero": "Noughty Rouge",
      "why": "Tomato with olive and caper can take Sangiovese acidity, but a briny Portuguese white matches the olive and caper salt while keeping it fresh.",
      "flags": [
        "gluten"
      ],
      "ingredients": [
    ...
    },
    {
      ...
      "category": "Pasta",
      "price": "22",
      "menu": "Truffled Mushroom, Parmesan Sauce",
      "flavor": "mushroom, truffle, parmesan, creamy",
      "wine": "Deinhard Deidesheim",
      "cocktail": "Spaghetti Western",
      "zero": "Noughty Rouge",
      "why": "Truffle and parmesan mirror an earthy light red or a nutty spirit-forward cocktail; matching earthy intensity beats heavy tannin.",
      "flags": [
        "dairy",
        "gluten"
      ],
    ...
    {
      "id": "grilled-farm-chicken",
      "lever": "match-intensity",
      "name": "Grilled Farm Chicken",
      "group": "food",
      "category": "Main",
      "price": "40",
      "menu": "Chicken Sausage, Dill Gravy, Fries",
      "flavor": "chicken, sausage, gravy, fries, dill",
      "wine": "Wagner-Stempel Weissburgunder",
      "cocktail": "Rolling Canoe",
      "zero": "Peroni Pilsner 0.0",
      "why": "Mild chicken and gravy stay easy with a soft white; if the guest wants richer, a rye-port cocktail matches the gravy without overwhelming the bird.",
      "flags": [
    ...
    {
      "id": "maple-bbq-rainbow-trout",
      "lever": "acid-cuts-fat",
      "name": "Maple BBQ Rainbow Trout",
      "group": "food",
      "category": "Main",
      "price": "38",
      "menu": "Creamed Kale, Smoked Potato Purée",
      "flavor": "trout, maple BBQ, smoke, creamy kale",
      "wine": "Vini be Good Hip Hop Chenin",
      "cocktail": "Heartbreak Mountain",
      "zero": "Gallina de Piel Neverwine",
      "why": "Sweet-savory maple and smoke over delicate trout want a high-acid, textured white (Chenin); acid balances the sweet glaze and body matches the creamy kale.",
      "flags": [
        "fish",
        "dairy"
      ],
    ...
    {
      "id": "wood-grilled-beef-strip-steak",
      "lever": "tannin-binds-protein",
      "name": "Wood Grilled Beef Strip Steak",
      "group": "food",
      "category": "Main",
      "price": "52",
      "menu": "Béarnaise, Charred Shallot, Pommes Paillasson, Wild Mushroom Jus",
      "flavor": "beef, butter sauce, mushroom jus, char",
      "wine": "St. John Claret",
      "cocktail": "Rolling Canoe",
      "zero": "Noughty Rouge",
      "why": "Beef protein and fat bind tannin, so a structured red (Claret) softens in the mouth while its fat-cutting grip resets the palate.",
      "flags": [
        "beef",
    ...
    {
      "id": "grilled-lamb-saddle",
      "lever": "tannin-binds-protein",
      "name": "Grilled Lamb Saddle",
      "group": "food",
      "category": "Main",
      "price": "47",
    ...
    {
      "id": "wood-roasted-half-duck",
      "lever": "acid-cuts-fat",
      "name": "Wood Roasted Half Duck",
      "group": "food",
      "category": "Main",
      "price": "46",
      "menu": "Turnips, Bitter Greens, Black Garlic Emulsion",
      "flavor": "duck, bitter greens, black garlic, roasted richness",
      "wine": "Deinhard Deidesheim",
      "cocktail": "White Peach Negroni",
      "zero": "Noughty Rouge",
      "why": "Duck fat loves a light, high-acid red (Pinot); acid cuts the richness while bitter greens and black garlic also welcome aperitivo bitterness.",
      "flags": [
    ...
    {
      "id": "26oz-wood-grilled-beef-ribeye",
      "lever": "tannin-binds-protein",
      "name": "26oz Wood Grilled Beef Ribeye",
      "group": "food",
      "category": "Main",
      "price": "125",
      "menu": "Pomme Aligot, Green Peppercorn, Smoked Bone Marrow Jus",
      "flavor": "big beef, cheese potato, peppercorn, bone marrow, smoke",
      "wine": "St. John Claret",
      "cocktail": "Spaghetti Western",
      "zero": "Noughty Rouge",
      "why": "The biggest beef-and-fat plate wants the most structured red: tannin binds the protein, and dark fruit and grip stand up to bone-marrow richness.",
      "flags": [
        "beef",
        "dairy",
        "bone marrow"
    ...
    {
      "id": "the-banana-pie",
      "lever": "match-sweetness",
      "name": "The Banana Pie",
      "group": "food",
      "category": "Dessert",
      "price": "16",
      "menu": "Coffee, Pretzel, Rum Caramel",
      "flavor": "banana, coffee, pretzel, rum caramel",
      "wine": "Valdespino Cream Sherry Isabela",
      "cocktail": "Rolling Canoe",
      "zero": "Sunrise Spritz",
      "why": "Sweet dessert needs an equally sweet or fortified partner; cream sherry echoes the toffee, orange, and pudding warmth without tasting thin.",
      "flags": [
        "gluten",
        "dairy",
        "confirm nuts"
    ...
    {
      "id": "matinee-snack-menu",
      "lever": "acid-cuts-fat",
      "name": "Matinee Snack Menu",
      "group": "food",
      "category": "Matinee / Late Night",
      "price": "varies",
  ...
  "beerZero": [
    "<p><strong>Crisp beer:</strong> Ol' Beautiful Okami Kasu Japanese Lager, Banded Peak Mount Crushmore Pilsner, Stella Artois, Michelob Ultra. Use for fries, oysters, garlic bread, and Margherita.</p>",
    "<p><strong>Hoppy beer:</strong> Establishment Afternoon Delight NEPA, 33 Acres Ocean Pale Ale, Superflux Happyness IPA, Banded Peak Microburst Hazy IPA. Use for salami, sausage, hummus chips, eggplant fries.</p>",
    "<p><strong>Sour/fruity:</strong> Four Winds Nectarous, Dandy The Julia Peach Cobbler Sour, Polyrhythm Matinee Lemon Cream Tart Ale, Uncommon Tropical Cider. Use for burrata, octopus, Apple Tatin, Banana Pie.</p>",
    "<p><strong>Rich beer:</strong> Born Arm Candy Milk Stout or Chimay Blue. Use for steak, ribeye, or Chocolate Pot de Crème.</p>",
    "<p><strong>No-alcohol wine:</strong> Gallina de Piel Neverwine for seafood, Freixenet Sparkling Wine for bubbles, Noughty Rouge for soft red-fruit pairings.</p>"
  ],
  "bottleLadders": [
    [
      "Bubbles",
      "Blue Mountain Brut -> Raventos i Blanc de Nit Rose -> Griesel Blanc de Noirs -> Christophe Mignon Adn de Meunier Brut Nature"
    ],
    [
      "Crisp seafood whites",
      "Hiedler Löss -> Landron Muscadet -> Denizot Sancerre"
    ],
    [
      "Rounder whites",
      "Bodega Cerron Blanco -> Eleonore Moreau Petit Chablis -> Mount Eden Wolff Vineyard -> Domaine Buisson-Charles Meursault"
    ],
    [
      "Light reds",
      "Deinhard Deidesheim -> Domaine de Colette -> Alta Mora Etna Rosso -> Pierre Thibert Chorey-les-Beaune"
    ],
    [
      "Steak reds",
      "St. John Claret -> Chateau Larose Perganson -> Whitehall Lane Merlot -> Aia Vecchia Sor Ugo -> White Rock Cabernet Sauvignon"
    ]
  ],
  "bottleMap": [
    [
      "Bubbly bottles",
      "Raventos i Blanc de Nit Rose; Cirelli Frizzante Bianco; Griesel Blanc de Noirs; Christophe Mignon Adn de Meunier Brut Nature."
    ],
    [
      "Crisp white bottles",
      "Denizot Sancerre; Ciro Picariello Bru Emm; Donnhoff Feinherb; Landron Muscadet-Sevre et Maine Amphibolite; Claire Naudin Mallon; Bideona Cabezadas; Cusumano Lucido."
    ],
    [
      "Textured white bottles",
      "Domaine Breton Pierres Rousses; Maloof Where Ya Pjs At? skin contact Pinot Gris; Clos Bellane Valreas; Domaine de la Rochette Macon-Bussieres Mont Sard; Domaine Buisson-Charles Meursault Vieilles Vignes; Mount Eden Wolff Vineyard."
    ],
    [
      "Light and medium red bottles",
      "Terroir Sense Fronteres Negre de Montsant; Charlotte & Jean Baptiste Senat Amalgame; Malahierba Vinos Maleza; Alta Mora Etna Rosso; Pierre Thibert Chorey-les-Beaune; Sandrine & Fabrice Gasnier Chinon Pierres Chaudes; Domaine de Colette Coteaux de Colette; Castello di Verduno Alba; Brandini Langhe Filari Corti."
    ],
    [
      "Structured red bottles",
      "Kistler Pinot Noir; Castello di Potentino Sacromonte; Fletcher Barbaresco Recta Pete; Texier Brezeme; Algre Valgañon; Gulfi Nerojbleo; Domaine Gour de Chaule Gigondas Les Jardinieres; Chateau Larose Perganson; Whitehall Lane Merlot; Aia Vecchia Sor Ugo Bolgheri Superiore; White Rock Cabernet Sauvignon."
    ]
  ]
};
